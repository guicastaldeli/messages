...
const std::string Base64Manager::base64_chars = 
    "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
    "abcdefghijklmnopqrstuvwxyz"
    "0123456789+/";

bool Base64Manager::is_base64(unsigned char c) {
    return (isalnum(c) || (c == '+') || (c == '/'));
}

std::string Base64Manager::encode(const std::vector<unsigned char>& data) {
    std::string ret;
    int i = 0;
    int j = 0;
...
std::vector<unsigned char> Base64Manager::decode(const std::string& encoded_string) {
